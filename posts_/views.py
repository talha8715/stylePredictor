...
class PostListView(ListView):
    ...
    paginate_by = 6
    template_name = 'posts_/post_list.html'
    ...
    def post(self, request, *args, **kwargs):
        ...
        if post_id2 is not None:
            post_id2 = request.POST.get('like')
            post = get_object_or_404(Post, id=post_id2)
...
class PostDetailView(DetailView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if comment:
            if c_slug:
                post = get_object_or_404(Post, slug=c_slug)
...
class PostCreateView(LoginRequiredMixin, SuccessMessageMixin, CreateView):
    template_name = 'posts_/post_form.html'
...
class MyPostView(LoginRequiredMixin, ListView):
    template_name = 'posts_/my_posts.html'
